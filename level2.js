...
create() {
    ...
    this.add.image(0,0, 'bakgrunn2').setScale(0.75).setOrigin(0.02,0); 
    ...
    gameState.startText = this.add.text(550, 300, 'Level 2!', { fontSize: '60px', fill: '#ff0000', fontFamily: 'Rock Kapak'  }).setOrigin(0.5);
...
function updateEnemyActions() {
    enemyActions = [ 
        {key: 'damage5', damage: 0, magic: 10, poison: 3, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 10 magic damagen\nDeals 3 poison', probability: 0.15 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
        {key: 'damage10', damage: 12, magic: 0, poison: 3, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 12 damage', probability: 0.225 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
        {key: 'damage15', damage: 17, magic: 0, poison: 3, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 17 damage', probability: 0.15 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
