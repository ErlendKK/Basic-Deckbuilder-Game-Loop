    ...
    // ---------------------------------- ENEMY'S TURN -------------------------------------      
        ...
        function updateEnemyActions() {
            enemyActions = [ 
                ...
                {key: 'damage10', damage: 12, magic: 0, poison: 3, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 12 damage\nDeals 3 poison', probability: 0.05 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
                {key: 'damage15', damage: 17, magic: 0, poison: 3, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 17 damage\nDeals 3 poison', probability: 0.15 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
