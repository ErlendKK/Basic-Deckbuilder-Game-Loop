class Level5 extends Phaser.Scene {
    ...
    function updateEnemyActions() {
        enemyActions = [ 
            ...
            {key: 'damage10', damage: 25, magic: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 25 damage', probability: 0.2 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
    ...
    function grantReward() {
        ...
        gameState.rewardAddCardsButton.on('pointerup', () => {
            ...
            const spacing = 220;  // spacing between cards
