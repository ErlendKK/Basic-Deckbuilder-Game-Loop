    ...
    // ---------------------------------- ENEMY'S TURN -------------------------------------      
        ...
        function updateEnemyActions() {
            enemyActions = [ 
                ...
                {key: 'damage10', damage: 15, magic: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 15 damage', probability: 0.05 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
                ...
                {key: 'poison1', damage: 0, magic: 0, poison: 5, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 5 poison', probability: 0.225 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6}
            ];
        }    
