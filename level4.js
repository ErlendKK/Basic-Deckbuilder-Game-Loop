class Level4 extends Phaser.Scene {
    ...
    function updateEnemyActions() {
        enemyActions = [ 
            {key: 'damage5', damage: 0, magic: 17, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 17 magic damagen', probability: 0.15 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
            {key: 'damage10', damage: 22, magic: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 22 damage', probability: 0.05 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6},
            ...
            {key: 'poison1', damage: 0, magic: 0, poison: 7, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Deals 7 poison', probability: 0.225 + ((gameState.enemy1.health === gameState.enemy1.healthMax) ? 0.20 : 0) / 6}
        ];
    }
